...
exports.getDoctors = async (req, res) => {
  try {
    // Find all staff where the role is exactly 'Doctor'
    // We only select the fields we need to keep the payload light and secure
...
exports.addStaff = async (req, res, next) => {
  try {
    ...
    res
      .status(201)
      .json({ success: true, data: newStaff, message: "Staff member added" });
  } catch (error) {
